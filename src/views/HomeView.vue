  ...
  <div class="home">
    <header>
      ...
      <div class="user-avatar">
        <el-popover placement="left" :width="50" trigger="hover">
          <template #reference>
            <el-avatar
      ...
      <aside>
        <el-menu default-active="2" class="el-menu-vertical-demo">
          ...
          <el-sub-menu index="4">
            ...
            <el-menu-item index="3-1" @click="$router.push('/pielinechart')"
              >男女抑郁分析</el-menu-item
            >
            <el-menu-item index="3-2" @click="$router.push('/barchart')"
              >城市抑郁分析</el-menu-item
            >
            <el-menu-item index="3-3" @click="$router.push('/hopperchart')"
              >星期抑郁分析</el-menu-item
            >
...
.home {
  ...
  header {
    ...
    box-shadow: 0 3px 3px rgba(0, 0, 0, 0.2); /* 添加阴影 */
    .project-title {
      display: flex;
      align-items: center;
      height: 100%;
  ...
  main {
    ...
    aside {
      ...
      width: 200px;
      margin-right: 12px;
      box-shadow: 3px 0 3px rgba(0, 0, 0, 0.2); /* 添加阴影 */
    }
    nav {
      display: flex;
      align-items: center;
      ...
      box-shadow: -2px -2px 3px rgba(0, 0, 0, 0.2); /* 添加阴影 */
    }
  }
}
</style>
